...
from model import GRS
import numpy as np
import logging
import os
from tqdm import tqdm
from loss import JointMseLoss, MseLoss
    ...
    for epoch in range(args['epochs']):
        ...
        with torch.no_grad():
            for j,(image,gt,sobel_gt) in tqdm(enumerate(valDataLoader),total=len(valDataLoader)):
                ...
                PSNR.append(criCalc.caclBatchPSNR((pre1+1)*127.5,(gt+1)*127.5))
